...
# target
wbcd_train_y <- wbcd.train[,1] # kolom ke-1 sebagai target variable

wbcd_test_y <- wbcd.test[,1]
```

Data prediktor akan discaling menggunakan z-score standarization. Data test juga harus discaling menggunakan parameter dari data train.
...
confusionMatrix(data = wbcd_pred, # hasil prediksi
                reference = wbcd_test_y, # data aktual
