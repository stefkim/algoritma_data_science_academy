...
* `BOROUGH`, `BLOCK`, `LOT`: int -> ...
* `ZIP.CODE`: int -> ...
* `RESIDENTIAL.UNITS`, `COMMERCIAL.UNITS`, `TOTAL.UNITS`: int -> ...
* `YEAR.BUILT`: int -> ...
...
* `NEIGHBORHOOD`: chr -> ...
* `BUILDING.CLASS.CATEGORY`, `BUILDING.CLASS.AT.PRESENT`, `BUILDING.CLASS.AT.TIME.OF.SALE`: chr -> ...
* `TAX.CLASS.AT.PRESENT`: chr -> ...
* `ADDRESS`: chr -> ...
* `APARTMENT.NUMBER`: chr -> ...
* `LAND.SQUARE.FEET`, `GROSS.SQUARE.FEET`: chr -> ...
* `SALE.PRICE`: chr -> ...
* `SALE.DATE`: chr -> ...
